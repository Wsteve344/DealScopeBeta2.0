/*
  ...
  2. Security
    ...
    - Only analysts can view and manage contact requests
    - Contact notes are only visible to analysts
*/
...
-- Only analysts can view contact requests
...
-- Only analysts can update contact requests
...
-- Only analysts can view contact notes
...
-- Only analysts can create contact notes
