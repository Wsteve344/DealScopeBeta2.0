/*
  ...
  1. Changes
    ...
    - Add policy to allow analysts to read all contact requests
    - Add policy to allow analysts to update contact requests

  2. Security
    - Enables RLS on contact_requests table
    - Adds appropriate policies for public and authenticated users
*/
